...
async def next_page(bot, query):
    ...
    btn.insert(1, 
        [
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/CINEMACCBOTDISCUSSION'),
            InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ', url='https://t.me/DMWITHGOKUL')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💥 ᴍᴏᴠɪᴇs ♥️', url='https://t.me/DARKSARVAR1')
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/CINEMACCBOTUPDATES'),
